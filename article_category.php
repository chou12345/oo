        ...
        <div class="row border-top px-xl-5">
            ...
            <div class="col-lg-9">
                ...
                <div class="navbar-nav mr-auto py-0">
                     <h2 align="center" style="margin-top: 10px;">文章類別</h2>
                        </div>
                        <a href="article_category1.php" class="btn border">
                    <i class="fas fa-pen text-primary"></i>
                    <span class="badge">新增類別</span>
                </a>
                    </div>
                </nav>
...
<!--                            <a href="" class="nav-item nav-link"></a>-->
                ...
                <table class="table table-bordered table-hover" width="1000px" height="250px" >
            <thead bgcolor="#ACD6FF">
            <tr>
                <th scope="col" width="50px" vertical-align:middle style="text-align:center">編號</th>
                <th scope="col" width="120px"vertical-align:middle >文章類別</th>
    </tr>
  </thead>
            <tbody>
                <?php
                  $link=mysqli_connect("localhost","root","12345678","system");
                       // $link=mysqli_connect("localhost","root");
                        ...
                        $sql="select *from dictionary where dictionary_kind='文章'";
...
<!--
            <tr>
                ...
                <th text-align="left" margin-left="1000px">選課</th>
    </tr>
            <tr>
...
<!--
            <tr>
                ...
                <td colspan="1"><a href="" class="fas fa-pen text-primary">審核帳號</a></td>
    </tr>
-->
  </tbody>
                </table>
