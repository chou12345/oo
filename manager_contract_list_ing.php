    ...
    <div class="container-fluid mb-5">
        <div class="row border-top px-xl-5">
            ...
            <div class="col-lg-9">
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                <div class="navbar-nav mr-auto py-0">
                         <a href="manager_contract_list.php" class="nav-item nav-link">合約一覽</a>
                        <a href="manager_contract_list_ing.php" class="nav-item nav-link active">待確認合約</a>
                        </div>
                </nav>
                ...
                <div>
	               ...
	               <input type=hidden name="method" value="query">
                        <table class="table">
                            ...
                            <tbody>
                            <?php
                                $man_conAll = query("SELECT * FROM profit_contract where contract_status = '簽訂中'");
                                //print_r($man_conAll);
                                $count_id = 1;
