                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <h2 align="center" style="margin-top: 10px;">修改管理員資料</h2>
                        </div>
...
<!--        <div class="flex">-->
<!--2-->
    <form action="manager_dblink.php" method=post>
        ...
        <div style="width: 800px; color: black;">
          <table class="table table-bordered" width="1000px" >
           <thead bgcolor="#ACD6FF">
             <tr>
             <td align="center" colspan="4"><b>管理員資料修改</b></td>
           </tr>
           </thead>
            <tbody>
            <tr>
            ...
            <input type=hidden name="name" value="<?php echo $record['name']; ?> " readonly></td>
            <td width="125px" bgcolor="#ACD6FF"><b>員工編號</b></td>
            <td width="250px" >
             <?php echo $record['manager_id'];?>
...
<!--            <td>0912345678</td>-->
            ...
            <td>ma1</td>
            <th scope="row" bgcolor="#ACD6FF">銀行帳號</th>
            <td>
            <?php echo $record['bank_account'];?>
            <input type=hidden name="bank_account" value="<?php echo $record['bank_account'];?>" readonly></td>
            </tr>
            <tr>
            <th scope="row" bgcolor="#ACD6FF">公鑰</th>
            <td colspan="3">
                <?php echo $record['public_key'];?>
                <input type=hidden name="public_key" value="<?php echo $record['public_key'];?>" readonly></td>
            </tr>
            <tr>
                <tr>
        <td  colspan="5" align = "center"><input type=submit class="btn btn-primary btn-md btn-block waves-effect waves-light text-center mt-10" style="width:200px; float:center;" value=送出></td>
        </tr>
         </tbody>
        </table>   
...
-->
                ...
                <!-- <div>
                    <a href="temp.html"><h1>我的商品</h1></a>
                    <a href="temp.html"><h1>我的合約</h1></a>
                </div> -->
                <!--旋轉木馬
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 410px;">
                            <img class="img-fluid" src="fi.jpg" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">如何用力痛快的玩耍٩( ᐛ )و</h4>
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4"></h3>
                                    <a href="" class="btn btn-light py-2 px-3">解鎖暑假</a>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item" style="height: 410px;">
