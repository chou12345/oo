...
//echo $merchant_id;
$merchant_conAll = query("SELECT * FROM profit_contract where merchant_id = $merchant_id and contract_status = '簽訂中'");
    ...
    <div class="container-fluid mb-5">
        <div class="row border-top px-xl-5">
            ...
            <div class="col-lg-9">
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                <div class="navbar-nav mr-auto py-0">
                         <a href="merchant_contract_list.php" class="nav-item nav-link">合約一覽</a>
                        <a href="merchant_contract_list_ing.php" class="nav-item nav-link active">待確認合約</a>
                        </div>
                </nav>
