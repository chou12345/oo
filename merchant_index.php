...
$merchant_info = query("SELECT * FROM merchant  where merchant_id = '$merchant_id'")[0];
//print_r($merchant_info);
//print_r($merchant_info['name']);
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <h2 align="center" style="margin-top: 10px;">商家首頁</h2>
                        </div>
                    </div>
                </nav>
        ...
        <div style="width: 800px; color: black;">
          <table class="table table-bordered" width="1000px" >
           <thead bgcolor="#ACD6FF">
             <tr>
             <td align="center" colspan="4"><b>商家資料</b></td>
           </tr>
           </thead>
            <tbody>
            <tr>
            <th scope="row" width="150px" bgcolor="#ACD6FF">商家名稱</th>
            <td width="250px"><?php  print_r($merchant_info['name']); ?></td>
            <td width="125px" bgcolor="#ACD6FF"><b>統一編號</b></td>
            <td width="250px"><?php echo $merchant_id; ?></td>
            </tr>
            <tr>
            <th scope="row" bgcolor="#ACD6FF">登入帳號</th>
            <td><?php  echo $merchant_id; ?></td>
            <td bgcolor="#ACD6FF"><b>連絡電話</b></td>
            <td><?php  print_r($merchant_info['phone']); ?></td>
            </tr>
            <tr>
            <th scope="row" bgcolor="#ACD6FF">email</th>
            <td colspan="3"><?php  print_r($merchant_info['email']); ?></td>

            </tr>
            <tr>
            <th scope="row" bgcolor="#ACD6FF">公鑰</th>
            <td colspan="3" style="word-break:break-all;"><?php  print_r($merchant_info['public_key']); ?></td>
            </tr>
            <tr>
         </tbody>
        </table>
