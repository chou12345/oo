            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <a href="post_open.php?post_id=<?php echo $post['post_id'] ?>" class="btn btn-sm text-dark p-0">
