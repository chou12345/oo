            ...
            <div class="col-lg-3 col-6 text-right">
                ...
                <a href="#" class="btn border"data-toggle="dropdown">
                    ...
                    <div class="dropdown-menu position-absolute bg-secondary">
                        ...
                        <a href="manager_contract.php" class="dropdown-item">我的合約</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary"><a href="report_post_update_result.php">確定</a></button>
      </div>
    </div>
  </div>
</div>
...
<!--         <a href="" class="nav-item nav-link"></a>-->
            ...
            <tr>
                ...
                <th scope="col" width="150px" vertical-align:middle>文章內容</th>
...
<label class="btn btn-secondary" for="option1">接受</label>
<input type="radio" class="btn-check" name="options1" id="option1" autocomplete="off">
<label class="btn btn-secondary" for="option1">駁回</label>
