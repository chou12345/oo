...
//echo $general_id;
$user_conAll = query("SELECT * FROM  article_contract where user_A = $general_id or user_B = $general_id");
    ...
    <div class="container-fluid mb-5">
        <div class="row border-top px-xl-5">
            ...
            <div class="col-lg-9">
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                <div class="navbar-nav mr-auto py-0">
                         <a href="user_contract_list.php" class="nav-item nav-link active">合約一覽</a>
                        <a href="user_contract_list_ing.php" class="nav-item nav-link">待確認合約</a>
                        </div>
                </nav>
