...
$general_id = $_SESSION['general_id'];
  ...
  if ($_POST['is_submit']) {
    query("update general_user set name=\"{$_POST['name']}\",nickname=\"{$_POST['nickname']}\",number=\"{$_POST['number']}\",subject=\"{$_POST['subject']}\",phone=\"{$_POST['phone']}\",email=\"{$_POST['email']}\"where general_id='$general_id'");
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <h2 align="center" style="margin-top: 10px;">編輯個人資料</h2>
                        </div>
                                      ...
                                      <div class="card mb-3">
                                        <div class="card-body">
                                          <div class="row">
                                            ...
                                            <div class="text-muted font-size-sm"><input type="text" name="name" class="form-control" placeholder="<?php echo $user['name'] ?>" value="<?php echo $user['name'] ?>"></div>
                                          </div>
                                          <hr>
                                          <div class="row">
                                            <div class="col-sm-3">
                                            ...
                                            <div class="text-muted font-size-sm"><input type="text" name="nickname" class="form-control" placeholder="<?php echo $user['nickname'] ?>" value="<?php echo $user['nickname'] ?>"></div>
                                          </div>
                                          <hr>
                                          <div class="row">
                                            <div class="col-sm-3">
                                            ...
                                            <div class="text-muted font-size-sm"><input type="text" name="number" class="form-control" placeholder="<?php echo $user['number'] ?>" value="<?php echo $user['number'] ?>"></div>
                                          </div>
                                          <hr>
                                          <div class="row">
                                            <div class="col-sm-3">
                                            ...
                                            <div class="text-muted font-size-sm"><input type="text" class="form-control" placeholder="<?php echo $user['gender'] ?>" value="<?php echo $user['gender'] ?>"></div>
                                          </div>
                                          <hr>
                                          <div class="row">
                                            <div class="col-sm-3">
                                            ...
                                            <div class="text-muted font-size-sm"><input type="text" name="subject" class="form-control" placeholder="<?php echo $user['subject'] ?>" value="<?php echo $user['subject'] ?>"></div>
                                          </div>
                                          <hr>
                                          <div class="row">
                                            <div class="col-sm-3">
                                            ...
                                            <div class="text-muted font-size-sm"><input type="text" name="phone" class="form-control" placeholder="<?php echo $user['phone'] ?>" value="<?php echo $user['phone'] ?>"></div>
                                          </div>
                                          <hr>
                                          <div class="row">
                                            <div class="col-sm-3">
                                            ...
                                            <div class="text-muted font-size-sm"><input type="text" name="email" class="form-control" placeholder="<?php echo $user['email'] ?>" value="<?php echo $user['email'] ?>"></div>
                                          </div>
                                          <hr>
                                          <hr>
                                          <div class="row">
                                            <div class="col-sm-12">
                                              <input class="btn btn-primary" type='submit' value="修改完成" href="">
                                            </div>
                                          </div>
                                        </div>
                                      </div>
